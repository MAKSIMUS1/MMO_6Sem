...
# Получаем лучшую модель из результатов GridSearchCV
best_svc_model = SVC(**SVC_grid.best_params_)
best_svc_model.fit(X_train_scaled, y_train)

# Рассчитываем точность модели на обучающих и тестовых данных
...
# Получаем прогнозы для тестового набора данных
...
# Построение ROC-кривых для всех четырех моделей
ax = plt.gca()
